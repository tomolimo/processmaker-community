...
// actual class may be a subclass -- as returned by UsersPropertiesPeer::getOMClass()
include_once 'classes/model/UsersProperties.php';

/**
 * Base static class for performing query and update operations on the 'USERS_PROPERTIES' table.
 *
 * 
 *
