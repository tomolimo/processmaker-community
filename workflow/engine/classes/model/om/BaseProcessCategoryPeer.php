...
// actual class may be a subclass -- as returned by ProcessCategoryPeer::getOMClass()
include_once 'classes/model/ProcessCategory.php';

/**
 * Base static class for performing query and update operations on the 'PROCESS_CATEGORY' table.
 *
 * 
 *
