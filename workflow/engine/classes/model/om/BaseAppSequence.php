...
include_once 'classes/model/AppSequencePeer.php';

/**
 * Base class that represents a row from the 'APP_SEQUENCE' table.
 *
 * 
 *
 * @package    workflow.classes.model.om
 */
abstract class BaseAppSequence extends BaseObject implements Persistent
{
    ...
    */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = AppSequencePeer::ID;
        }
    ...
    public function delete($con = null)
    {
        ...
        try {
            $con->begin();
            AppSequencePeer::doDelete($this, $con);
    ...
    protected function doSave($con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->isModified()) {
                if ($this->isNew()) {
                    $pk = AppSequencePeer::doInsert($this, $con);
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = AppSequencePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = AppSequencePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
     ...
     * objects.
     *
     * @param      object $copyObj An object of AppSequence (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return     AppSequence Clone of current object.
     * @throws     PropelException
     */
     ...
     *
     * @return     AppSequencePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new AppSequencePeer();
        }
        return self::$peer;
    }
}
